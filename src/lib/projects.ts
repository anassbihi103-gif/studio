...
export const projects: Project[] = [
  {
    ...
    explanation: "This project focuses on adapting an existing consumer gadget to enhance its connectivity with computers. The core innovation involves converting the device from a wireless (Wi-Fi) interface to a wired connection, ensuring more stable and reliable data transfer. The process includes detailed engineering modifications to the gadget’s design. As part of the project deliverables, a comprehensive set of photorealistic renders was created to support marketing and social media campaigns. These renders highlight the device’s design, new connectivity features, and usability in a professional context. Additionally, artistic product animations were developed to visually communicate the transformation process and showcase the gadget in dynamic, engaging scenarios. The project demonstrates a combination of technical design, and visual communication, bridging engineering innovation with compelling visual storytelling for both technical and consumer-facing audiences",
    process: {
