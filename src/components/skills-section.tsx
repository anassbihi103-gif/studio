        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {softwareSkills.map((skill, idx) => (
              <div key={idx} className="p-6 rounded-2xl bg-secondary border border-border flex flex-col items-center justify-center text-center space-y-4 hover:border-primary/50 transition-colors group">
                <div className="p-4 bg-secondary/80 rounded-xl text-muted-foreground group-hover:text-primary group-hover:bg-cyan-950/30 transition-all">
                  {skill.icon}
                </div>
